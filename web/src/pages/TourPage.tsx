...
function Step2() {
  return (
    <>
      ...
      <p>
        5. You can change the predicted <b>number of turns ahead</b>, shown in the squares, that takes for the Knight to
      ...
      <p>
        6. You can <b>Restart the game</b> by clicking the button in the helper menu.
      </p>

      <ButtonsContainer>
        <ButtonLink to="/">Back to initial page</ButtonLink>
